...
public class ERC20 extends Contract {
    ...
    public static final String FUNC_CANUNLOCKAMOUNT = "canUnlockAmount";
    ...
    public static final String FUNC_ENDRELEASEBLOCK = "endReleaseBlock";
    ...
    public static final String FUNC_LASTUNLOCKBLOCK = "lastUnlockBlock";

    public static final String FUNC_LOCK = "lock";

    public static final String FUNC_LOCKOF = "lockOf";

    public static final String FUNC_MANUALMINT = "manualMint";

    public static final String FUNC_MANUALMINTLIMIT = "manualMintLimit";

    public static final String FUNC_MANUALMINTED = "manualMinted";
    ...
    public static final String FUNC_SETRELEASEBLOCK = "setReleaseBlock";

    public static final String FUNC_STARTRELEASEBLOCK = "startReleaseBlock";

    public static final String FUNC_SYMBOL = "symbol";

    public static final String FUNC_TOTALBALANCEOF = "totalBalanceOf";

    public static final String FUNC_TOTALLOCK = "totalLock";
